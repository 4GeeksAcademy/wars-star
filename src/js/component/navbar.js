    ...
    <nav className="navbar navbar-light bg-light mb-3">
      ...
      <ul className="dropdown-menu end-0">
        {store.favoritos.map(name => (
          <li> {name}<span onClick={() => actions.eliminarFavorito(name)}><button className="ms-2 btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
